H:\vue\vue-ui\node_modules\_@vue_cli-service@4.5.9@@vue\cli-service\bin\vue-cli-service.js
[ { title: 'vue-ui',
    ...
    template: 'H:\\vue\\vue-ui\\public\\index.html' } ]
{
  mode: 'production',
  context: 'H:\\vue\\vue-ui',
  ...
  output: {
    path: 'H:\\vue\\vue-ui\\dist',
    filename: 'js/[name].[contenthash:8].js',
    publicPath: '/badminton/',
      ...
      /* config.module.rule('vue') */
      {
        ...
        use: [
          /* config.module.rule('vue').use('cache-loader') */
          {
            ...
            options: {
              cacheDirectory: 'H:\\vue\\vue-ui\\node_modules\\.cache\\vue-loader',
              cacheIdentifier: 'ca552a2a'
            }
          },
          /* config.module.rule('vue').use('vue-loader') */
          {
            loader: 'H:\\vue\\vue-ui\\node_modules\\_vue-loader@15.9.5@vue-loader\\lib\\index.js',
            options: {
              compilerOptions: {
                whitespace: 'condense'
              },
  ...
  plugins: [
    ...
    new CopyPlugin(
      [
        {
          from: 'H:\\vue\\vue-ui\\public',
          to: 'H:\\vue\\vue-ui\\dist',
          toType: 'dir',
          ignore: [
            '.DS_Store',
            {
